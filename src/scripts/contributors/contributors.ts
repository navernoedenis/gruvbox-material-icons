...
const fetchContributors = (
  ...
  return new Promise((resolve, reject) => {
    const config: AxiosRequestConfig = {
      method: 'get',
      url: `https://api.github.com/repos/pkief/vscode-gruvbox-material-icons/contributors`,
      params: { page },
      headers: {
...
const init = async () => {
  ...
  // create the image
  console.log('> Gruvbox Material Icons:', yellow('Creating image...'));
  ...
  createScreenshot(outputPath, fileName)
    ...
    .catch((error) => {
      console.log('> Gruvbox Material Icons:', red(`Error: ${error}`));
